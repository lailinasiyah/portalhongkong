<?php
echo password_hash("rani123", PASSWORD_DEFAULT)."<br>";
echo password_hash("victor123", PASSWORD_DEFAULT)."<br>";
echo password_hash("elis123",PASSWORD_DEFAULT)."<br>";
echo password_hash("wesley123",PASSWORD_DEFAULT)."<br>";
